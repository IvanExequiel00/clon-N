      ...
      >
        <div className="pt-24 md:pt-0">
          ...
          <p className="max-w-md mt-2 text-xs md:text-base">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis pariatur aut deleniti magni, velit minima natus ut rerum odio sit soluta aperiam, sunt veniam libero quae quisquam fugit fugiat fuga.
          </p>
