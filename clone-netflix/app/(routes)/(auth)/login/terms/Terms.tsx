...
export  function Terms() {
  ...
  return (
    <div className="text-xs mt-4 mb-10 text-gray-600 max-w-72">
        <div className="mb-5">
        <span>
            Esta pagina usa google reCaptcha para verificar que no eres un robot
        </span>
        <Button variant="ghost" className="opacity-1 text-[#0071eb] hover:bg-transparent p-0 ml-1 h-fit" onClick={() => setshowExtraTerms(!showExtraTerms)}>Mas informacion</Button>
        </div>
        <div className="h-28">
            {showExtraTerms && 
            <p>
